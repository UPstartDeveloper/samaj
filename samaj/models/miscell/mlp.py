...
class BinaryClassificationMLP(base.BaseModel):
    ...
    def define_model(self, num_features: int) -> None:
        ...
        for layer_index in range(self.num_layers):
            ...
            layer_weights = self.rng.uniform(low=-limit, high=limit, size=(fan_in, fan_out))
    ...
    def backward(self, X, y, learning_rate, activations):
        ...
        derivative_hidden_bias = db1 = (1 / num_samples) * np.sum(dZ1, axis=1, keepdims=True)
...
if __name__ == "__main__":
    ...
    custom_mlp = BinaryClassificationMLP(
        num_layers, units_per_layer, num_features,
    )
